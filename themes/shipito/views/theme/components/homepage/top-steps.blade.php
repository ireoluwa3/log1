        ...
        <div class="row top-steps-row mobile-only">
            ...
            <div class="{{$col_width}} col-md-6 text-center">
                ...
                <div class="step-description light">
                    <div class=" mobile-only">
                        <div  >
                            <img  src="{{ theme_setting_image($section->id,'slides_1_img') != '' ? theme_setting_image($section->id,'slides_1_img') : (get_general_setting('website_logo', asset('themes/shipito/assets/imgs/home/step1.svg'))) }}"    class="mobile-only" />
                        </div>
                        <div  style="{{ $textColor }}" >  {{$data['description_1_whyus'][app()->getLocale()] ?? ''}} </div>
                        <br><hr><br>
                    </div>
                </div>
            </div>
            ...
            <div class="{{$col_width}} col-md-6 text-center middle-column">
                ...
                <div class="step-description light">
                    <div class=" mobile-only">
                        <div >
                            <img src="{{ theme_setting_image($section->id,'slides_2_img') != '' ? theme_setting_image($section->id,'slides_2_img') : (get_general_setting('website_logo', asset('themes/shipito/assets/imgs/home/step2.svg'))) }}"   class="mobile-only" />
                        </div>
                        <div  style="{{ $textColor }}" > {{$data['description_2_whyus'][app()->getLocale()] ?? ''}} </div>
                        <br><hr><br>
                    </div>
                </div>
            </div>
            ...
            <div class="{{$col_width}} col-md-6 text-center">
                ...
                <div class="step-description light">
                    <div class=" mobile-only">
                        <div >
                            <img  src="{{ theme_setting_image($section->id,'slides_3_img') != '' ? theme_setting_image($section->id,'slides_3_img') : (get_general_setting('website_logo', asset('themes/shipito/assets/imgs/home/step3.svg'))) }}"  class="mobile-only" />
                        </div>
                        <div  style="{{ $textColor }}"> {{$data['description_3_whyus'][app()->getLocale()] ?? ''}} </div>
                        <br><br>
                    </div>
                </div>
            </div>
